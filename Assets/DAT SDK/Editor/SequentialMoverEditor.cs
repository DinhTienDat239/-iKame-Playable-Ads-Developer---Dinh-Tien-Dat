...
public class SequentialMoverEditor : UnityEditor.Editor
{
    ...
    void OnEnable()
    {
        ...
        enableSkipOnTargets = serializedObject.FindProperty("enableSkipOnTargets");
        targetsSkip = serializedObject.FindProperty("targetsSkip");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(enableSkipOnTargets, new GUIContent("Enable Skip On Targets"));
        if (enableSkipOnTargets.boolValue)
        {
            EditorGUI.indentLevel++;
            EditorGUILayout.PropertyField(targetsSkip, new GUIContent("Targets Skip"), true);
            EditorGUI.indentLevel--;
        }
        ...
        else if ((MoveMode)moveMode.enumValueIndex == MoveMode.Noise)
        {
            EditorGUILayout.Slider(noiseStrength, 0f, 100f, new GUIContent("Noise Strength"));
        }
