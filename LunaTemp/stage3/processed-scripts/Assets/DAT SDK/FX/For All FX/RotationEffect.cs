...
namespace DAT.UI.FX
{
    ...
    public class RotationEffect : MonoBehaviour
    {
        ...
        private Tween CreateRotation([Bridge.Ref] Vector3 target, [Bridge.Ref] Vector3 secondTarget, float stepDuration)
        {
        ...
        private Tween CreateRotation([Bridge.Ref] Vector3 target, float stepDuration)
        {
            if (snap)
            {
                Sequence seq = DOTween.Sequence().SetUpdate(true);
