...
public class CarController : MonoBehaviour
{
    ...
    private bool TryDetectAheadCar(Vector3 rayOrigin, Vector3 dir, float totalRayDistance, out float blockedSpeed)
    {
        blockedSpeed = 0f;
    ...
    public void MoveInQueue(Vector3 target, bool setFirstLineOnComplete)
    {
        isMoving = true;
        isFirstLine = false;
