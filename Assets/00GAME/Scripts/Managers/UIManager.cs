...
public class UIManager : MonoBehaviour
{
    ...
    private void ShowEndScreen(Image screen, Image icon, TextMeshProUGUI txt, Image ctaBtn, Vector3 ctaDefaultScale)
    {
        KillEndScreenTween();
    ...
    private void PlayEndScreenPopups(Image icon, TextMeshProUGUI txt, Image ctaBtn, Vector3 ctaDefaultScale)
    {
        Sequence sequence = DOTween.Sequence();
    ...
    private void StartCtaPulse(Image ctaBtn, Vector3 defaultScale)
    {
        StopCtaPulse();
