...
namespace DAT.UI.FX
{
    ...
    public class PulseEffect : MonoBehaviour
    {
        ...
        private void BuildPulseTween([Bridge.Ref] Vector3 toScale, int stepCount)
        {
        ...
        private void BuildPulseTween([Bridge.Ref] Vector3 toScaleA, [Bridge.Ref] Vector3 toScaleB, int stepCount)
        {
            float stepDuration = duration / stepCount;
            Sequence seq = DOTween.Sequence().SetUpdate(true);
