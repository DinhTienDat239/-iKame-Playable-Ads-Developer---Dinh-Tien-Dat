...
namespace DAT.Core.Motion
{
    ...
    public class MouseFollower : MonoBehaviour
    {
       [Header("Motion Settings")]
        ...
        private Vector2 ClampToRect([Bridge.Ref] Vector2 pos, [Bridge.Ref] Rect bounds)
        {
        ...
        private Vector3 ClampToRect([Bridge.Ref] Vector3 pos, [Bridge.Ref] Rect bounds)
        {
            float clampedX = Mathf.Clamp(pos.x, bounds.xMin, bounds.xMax);
            float clampedY = Mathf.Clamp(pos.y, bounds.yMin, bounds.yMax);
        ...
        public void SetMouseOffset([Bridge.Ref] Vector2 offset)
        {
            mouseOffset = offset;
        }
